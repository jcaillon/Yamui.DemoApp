...
namespace _3PA.MainFeatures.Appli.Pages.Options {
    partial class ProfilesPage {
        ...
        private void InitializeComponent() {
            this.scrollPanel = new YamuiScrollPanel();
            ...
            // 
            this.scrollPanel.Controls.Add(this.yamuiFilteredTypeTreeList1);
            this.scrollPanel.Controls.Add(this.yamuiScrollList1);
            this.scrollPanel.Controls.Add(this.yamuiFilteredTypeList1);
            this.scrollPanel.Controls.Add(this.btMinus);
            this.scrollPanel.Controls.Add(this.btPlus);
            this.scrollPanel.Controls.Add(this.yamuiButton4);
            this.scrollPanel.Controls.Add(this.yamuiButton3);
            this.scrollPanel.Controls.Add(this.yamuiButton2);
            this.scrollPanel.Controls.Add(this.flFilter1);
            this.scrollPanel.Controls.Add(this.yamuiButton1);
            this.scrollPanel.Controls.Add(this.YamuiFilteredList1);
            this.scrollPanel.Controls.Add(this.yamuiLabel3);
            this.scrollPanel.Controls.Add(this.yamuiLabel2);
            this.scrollPanel.Controls.Add(this.yamuiLabel1);
        ...
        private Yamui.Framework.HtmlRenderer.WinForms.HtmlToolTip htmlToolTip1;
